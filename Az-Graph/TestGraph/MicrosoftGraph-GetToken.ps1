...
$upn = "AdminUnitUser2@demo.acp.at"
$url = 'https://graph.microsoft.com/beta/users?&$filter=userPrincipalName+eq+''{0}''&$select=userPrincipalName,givenName,surname,displayName,onPremisesSecurityIdentifier' -f $upn
